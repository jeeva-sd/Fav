    ...
    <section className='dark:bg-gray-900 lg:pt-10 lg:pb-16 md:pt-10 md:pb-16 pt-20 pb-24 shadow-inner px-4'>
      <div className='py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6'>
        <div className='mx-auto max-w-screen-md sm:text-center'>
          ...
          <p className='mx-auto mb-8 max-w-2xl text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400'>Stay up to date with the latest posts, announcements and exclusive discounts feel free to sign up with your email.</p>
