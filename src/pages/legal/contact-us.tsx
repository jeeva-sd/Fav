...
const ContactUs: React.FC = () => {
  ...
  const seoParams: SeoParams= {
    ...
    description: 'contact us, favinsta, favinsta.com, contact fav insta, contact favinsta, instagram hastag generator, instagram tips, instagram porfile picture',
    keywords: 'contact us, favinsta, favinsta.com, contact fav insta, contact favinsta, instagram hastag generator, instagram porfile picture',
    pageUrl: pathname,
  };
