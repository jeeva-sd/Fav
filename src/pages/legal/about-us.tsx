...
const AboutUs: React.FC = () => {
  ...
  const seoParams: SeoParams= {
    ...
    description: 'about us, favinsta, favinsta.com, about fav insta, about favinsta, instagram hastag generator',
    keywords: 'about us, favinsta, favinsta.com, about fav insta, about favinsta, instagram hastag generator',
    pageUrl: pathname,
  };
