          ...
          <Container>
            ...
            <div className='mt-10'>
              <div className='mb-4'>
                ...
                <figure className='text-sm font-medium mt-5 mb-10'><Image width={1000} height={600} src={require('~/assets/images/blog/insight.webp')} alt='' className='rounded-md' />
              ...
              <div className='mt-16'>
                ...
                <figure className='text-sm font-medium mb-10 mt-5'><Image width={1000} height={600} src={require('~/assets/images/blog/hastag_container.webp')} alt='' className='rounded-md' />
              ...
              <div className='mt-16'>
                ...
                <figure className='text-sm font-medium mb-10 mt-5'><Image width={1000} height={600} src={require('~/assets/images/blog/followers.webp')} alt='' className='rounded-md' />
              ...
              <div className='mt-16'>
                ...
                <figure className='text-sm font-medium mb-10 mt-5'><Image width={1000} height={600} src={require('~/assets/images/blog/post_regular_time.webp')} alt='' className='rounded-md' />
              ...
              <div className='mt-16'>
                ...
                <figure className='text-sm font-medium mb-10 mt-5'><Image width={1000} height={600} src={require('~/assets/images/blog/stories.webp')} alt='' className='rounded-md' />
              ...
              <div className='mt-16'>
                ...
                <figure className='text-sm font-medium mb-10 mt-5'><Image width={1000} height={600} src={require('~/assets/images/blog/ads.webp')} alt='' className='rounded-md' />
